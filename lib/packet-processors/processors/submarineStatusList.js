...
exports.submarineStatusList = void 0;
function submarineStatusList(buffer) {
    return {
        statusList: Array(4)
            .fill(null)
            .map(function () { return ({
...
exports.submarineStatusList = submarineStatusList;
//# sourceMappingURL=submarineStatusList.js.map