...
exports.playerSpawn = void 0;
function playerSpawn(reader, constants, region) {
    return {
        ...
        models: Array(10)
            .fill(null)
            .map(function () { return reader.nextUInt32(); }),
