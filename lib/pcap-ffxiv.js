...
var dll_inject_1 = require("@ffxiv-teamcraft/dll-inject");
...
var CaptureInterface = /** @class */ (function (_super) {
    ...
    CaptureInterface.prototype.getXIVPID = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var fromInjector = (0, dll_inject_1.getPIDByName)("ffxiv_dx11.exe");
            if (fromInjector > 0) {
        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                this.getXIVPID()
                    ...
                    var res = (0, dll_inject_1.injectPID)(pid, dllPath);
                    _this._options.logger({
                        type: "info",
