...
export type Message = ActorCastMessage | ActorControlMessage | ActorControlSelfMessage | ActorControlTargetMessage | ActorFreeSpawnMessage | ActorGaugeMessage | ActorMoveMessage | ActorOwnerMessage | ActorSetPosMessage | AddStatusEffectMessage | AirshipExplorationResultMessage | AirshipStatusMessage | AirshipStatusListMessage | AirshipTimersMessage | BlackListMessage | CFAvailableContentsMessage | CFDutyInfoMessage | CFPlayerInNeedMessage | CFRegisterDutyMessage | CharaVisualEffectMessage | ClientTriggerMessage | ContainerInfoMessage | CraftingLogMessage | CurrencyCrystalInfoMessage | DesynthResultMessage | EffectMessage | EffectResultMessage | EorzeaTimeOffsetMessage | EquipDisplayFlagsMessage | EventFinishMessage | EventPlayMessage | EventPlay32Message | EventPlay4Message | EventPlay64Message | EventPlay8Message | EventPlayNMessage | EventStartMessage | FreeCompanyDialogMessage | FreeCompanyInfoMessage | FreeCompanyUpdateShortMessageMessage | GatheringLogMessage | InitZoneMessage | InventoryModifyHandlerMessage | InventoryTransactionMessage | IslandWorkshopSupplyDemandMessage | ItemInfoMessage | ItemMarketBoardInfoMessage | LogMessageMessage | LogoutMessage | MarketBoardItemListingMessage | MarketBoardItemListingCountMessage | MarketBoardItemListingHistoryMessage | MarketBoardPurchaseMessage | MarketBoardPurchaseHandlerMessage | MarketBoardSearchResultMessage | MountMessage | NpcSpawnMessage | ObjectSpawnMessage | PersistentEffectMessage | PlayTimeMessage | PlayerSetupMessage | PlayerSpawnMessage | PlayerStatsMessage | PrepareZoningMessage | ResultDialogMessage | RetainerInformationMessage | ServerNoticeMessage | StatusEffectListMessage | SubmarineExplorationResultMessage | SubmarineProgressionStatusMessage | SubmarineStatusListMessage | SubmarineTimersMessage | SystemLogMessageMessage | UpdateClassInfoMessage | UpdateHpMpTpMessage | UpdateInventorySlotMessage | UpdatePositionHandlerMessage | UpdatePositionInstanceMessage | WeatherChangeMessage | ActorControlActionStartMessage | ActorControlAutoAttackMessage | ActorControlDailyQuestSeedMessage | ActorControlEObjSetStateMessage | ActorControlFishingBaitMsgMessage | ActorControlSetMountSpeedMessage | ActorControlStatusEffectLoseMessage | ActorControlToggleWeaponMessage | ActorControlUpdateRestedExpMessage | ActorControlSelfActionStartMessage | ActorControlSelfAutoAttackMessage | ActorControlSelfDailyQuestSeedMessage | ActorControlSelfEObjSetStateMessage | ActorControlSelfFishingBaitMsgMessage | ActorControlSelfSetMountSpeedMessage | ActorControlSelfStatusEffectLoseMessage | ActorControlSelfToggleWeaponMessage | ActorControlSelfUpdateRestedExpMessage | ActorControlTargetActionStartMessage | ActorControlTargetAutoAttackMessage | ActorControlTargetDailyQuestSeedMessage | ActorControlTargetEObjSetStateMessage | ActorControlTargetFishingBaitMsgMessage | ActorControlTargetSetMountSpeedMessage | ActorControlTargetStatusEffectLoseMessage | ActorControlTargetToggleWeaponMessage | ActorControlTargetUpdateRestedExpMessage | DesynthResultItemDesynthResultMessage | DesynthResultMarketTaxRatesMessage | ResultDialogReductionResultMessage;
